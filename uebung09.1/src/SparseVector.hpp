...
public:
     ...
     */
    SparseVector<T>(int s = 0);

    /**
     * Copy constructor
     */
    SparseVector<T>(const SparseVector &c);
    ~SparseVector();
     ...
     * Assignment operator
     */
    SparseVector<T>& operator=(const SparseVector<T> &b);

    /**
     * Checks if two vectors are equal
     */
    bool operator==(const SparseVector<T> &b) const;
...
private:
    ...
    void copy(const SparseVector<T> &other);
